...
# GLOBAL PARAMETERS
OPTIMIZERS = ['fedavg', 'fedprox', 'feddane', 'fedddane', 'fedsgd', 'fedprox_origin','cmfl','fedavg_attack','fedavg_xiaoli']
...
def read_options():
    ...
    parser.add_argument('--drop_percent',
                        ...
                        type=float,
                        default=0)
    parser.add_argument('--active_rate',
                        help='active_rate',
                        type=float,
                        default=0.1)
    parser.add_argument('--attack_rate',
                        ...
                        type=float,
                        default=0)
    parser.add_argument('--committee_rate',
                        help='committee_rate',
                        type=float,
                        default=0.4)
    parser.add_argument('--aggregation_rate',
                        help='aggregation_rate',
                        type=float,
                        default=0.4)
    ...
    parser.add_argument('--merge_method',
                        ...
                        type=int,
                        default=0)
    parser.add_argument('--record_log',
                        help='log_file_log name',
                        type=str,
                        default='debug')
